package halfbloodpro.flowable.shipping_service.Service;
...
public class KafkaConsumer {
    ...
    @KafkaListener(topics = "saga-events", groupId = "shipping-group")
    public void listen(String message) {
        ...
        switch (json.getString("event"))
        {
            ...
            {
                event = "OrderShipped";
                logger.info("Shipping order action completed, sending message to Kafka. OrderId: {}, Event: {}", orderId, event);
