package halfbloodpro.flowable.inventory_service.Service;
...
public class KafkaConsumer {
    ...
    @KafkaListener(topics = "saga-events", groupId = "inventory-group")
    public void listen(String message) {
        ...
        {
            case "sendReserveInventory" ->
            {
                //DO relevant task e.g. reserve inventory and update inventory status in DB
